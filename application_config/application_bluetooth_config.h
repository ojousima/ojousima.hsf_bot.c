...
#define DEVICE_FWREV                    "0.0.1"                                     /**< Github tag. Do not include specifiers such as -alpha. */
...
#define APP_TX_POWER                    4                                           /**< Advertising power, in dBm. is rounded up to nearest allowable if desired power is not available. */
